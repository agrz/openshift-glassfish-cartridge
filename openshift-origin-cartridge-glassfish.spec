%global cartridgedir %{_libexecdir}/openshift/cartridges/v2/glassfish

Summary:       Provides Glassfish support
Name:          openshift-origin-cartridge-glassfish
Version: 	   0.1.0
Release:       1%{?dist}
...
%description
Provides Glassfish support to OpenShift
...
%{_sbindir}/oo-admin-cartridge --action install --offline --source /usr/libexec/openshift/cartridges/v2/glassfish
